...
data class APICondition(var text: String? = null, var icon: String? = null)
...
data class APICurrentWeather(var location: APILocation? = null, var current: APIWeather? = null)
